...
[@thisemil](https://twitter.com/thisemil) ©️ Emil Nilsson - För Nackademin IOT20_INTRO 🙅‍♂️
...
# Note
    Alla behöver en Kodeditor. Välj vad ni vill. Jag kör Visual Studio Code <-- Bra val 😇
